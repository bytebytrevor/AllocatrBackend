        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAllocat = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "AllocatProfiles",
                columns: table => new
                {
                    AllocatrUserId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AllocatProfiles", x => x.AllocatrUserId);
                    table.ForeignKey(
                        name: "FK_AllocatProfiles_AspNetUsers_AllocatrUserId",
                        column: x => x.AllocatrUserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowBids = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "ProjectAllocats",
                columns: table => new
                {
                    ProjectId = table.Column<Guid>(type: "uuid", nullable: false),
                    AllocatId = table.Column<Guid>(type: "uuid", nullable: false),
                    AssignedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectAllocats", x => new { x.ProjectId, x.AllocatId });
                    table.ForeignKey(
                        name: "FK_ProjectAllocats_AspNetUsers_AllocatId",
                        column: x => x.AllocatId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectAllocats_Projects_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_AllocatProfiles_AllocatProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_AllocatProfileId",
                table: "Reviews",
